...
The streaming paradigm is a viable vehicle for many modern high-performance applications.
Programs expressed as stream graphs have the property to be decomposable into large-grained parallel executing units, whereas for normal sequential code this is known to be difficult.
...
This thesis investigates the provision of fault-tolerance to a stream programming framework running on the cloud.
