...
\begin{columns}
\begin{column}{4cm}
\center{\includegraphics[height=5cm]{../res/computerfire.jpg}}
\end{column}
\begin{column}{6cm}
\begin{itemize}
...
\end{column}
\begin{column}{4cm}
\center{\includegraphics[height=4cm]{../res/schedule.jpg}}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}{Plan}
\center{\includegraphics[width=10cm]{../res/gantt.png}}
\end{frame}
